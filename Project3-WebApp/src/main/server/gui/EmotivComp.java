...
public class EmotivComp extends JFrame implements WindowListener {
  ...
  private static EmotivComp instance = null;
  ...
  public static void main(String[] args) {
    EmotivComp frame = EmotivComp.getInstance();
    frame.setVisible(true);
  }

  public static EmotivComp getInstance() {
    if (instance == null) {
      instance = new EmotivComp();
    }
    return instance;
  };
